...
const App = () => {
  ...
  const [availableTrainings, setAvailableTrainings] = useState([
    ...
    { id: 'TRAINING_v7', name: '📊 Training Run v7 (Recovered)', version: 'v5.2-v7', url: './data/training_v7.jsonl', type: 'historical' },
    { id: 'TRAINING_1', name: '📊 Training 1 (v5.1)', version: 'v5.1', url: './data/training_1.jsonl', type: 'historical' },
    { id: 'TRAINING_2', name: '📊 Training 2 (v5.2)', version: 'v5.2.1', url: './data/training_2.jsonl', type: 'historical' },
  ]);
